...
export var Header = function (_a) {
    ...
    return (React.createElement("header", null,
        React.createElement("div", { className: "wrapper" },
            ...
            React.createElement("div", null, user ? (React.createElement(Button, { size: "small", onClick: onLogout, text: "Log out" })) : (React.createElement(React.Fragment, null,
                React.createElement(Button, { size: "small", onClick: onLogin, text: "Log in" }),
                React.createElement(Button, { primary: true, size: "small", onClick: onCreateAccount, text: "Sign up" })))))));
};
